...
export const OrgScopedLayout: React.FC = () => {
  ...
  // Check if current route needs narrower content (settings, team, etc.)
        ...
        <div className="relative min-h-screen w-full bg-gradient-to-br from-background via-background/95 to-background/90 overflow-hidden">
          ...
          <div className="relative flex w-full pt-16 items-stretch">
            ...
            <SidebarInset className="flex justify-center overflow-hidden w-full">
              <div className={`mx-1 sm:mx-2 lg:mx-4 my-4 sm:my-6 w-full ${isNarrowPage ? 'max-w-5xl xl:max-w-6xl' : ''} rounded-2xl sm:rounded-3xl border border-border/60 bg-card/75 px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 shadow-lg shadow-primary/20 backdrop-blur-xl animate-fade-in overflow-x-hidden`}>
                <Routes>

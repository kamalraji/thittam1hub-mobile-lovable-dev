...
function getSidebarMenuButtonClasses(variant: SidebarMenuButtonVariant = "default", size: SidebarMenuButtonSize = "default"): string {
  ...
  const variantClasses: Record<SidebarMenuButtonVariant, string> = {

...
import type { ToggleSize, ToggleVariant, ToggleVariantsProps } from "@/components/ui/toggle";
...
const ToggleGroup = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ToggleGroupPrimitive.Root> & ToggleGroupVariantContext

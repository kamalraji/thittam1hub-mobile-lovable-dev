...
const sheetBySide: Record<SheetSide, string> = {
...
const sheetVariants = ({ side = "right", className }: { side?: SheetSide; className?: string } = {}) =>
  cn(sheetBase, sheetBySide[side], className);

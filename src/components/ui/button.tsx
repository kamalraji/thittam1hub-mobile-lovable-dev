...
type ButtonVariant = "default" | "destructive" | "outline" | "secondary" | "ghost" | "link" | "doodle" | "doodle-outline" | "sunny" | "teal" | "hero";
...
function buttonVariants(options: ButtonVariantOptions = {}): string {
  ...
  const base = "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0";

...
const byVariant: Record<ToggleVariant, string> = {
  default: "bg-transparent",
  outline: "border border-input bg-transparent hover:bg-accent hover:text-accent-foreground",
};

const bySize: Record<ToggleSize, string> = {
  default: "h-10 px-3",
  sm: "h-9 px-2.5",
  lg: "h-11 px-5",
};

// Function-based variants (stable in dev refresh; avoids cva initialization issues)
const toggleVariants = ({ variant = "default", size = "default", className }: ToggleVariantsProps = {}) =>

  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        ...
        className="relative p-2 text-muted-foreground hover:text-foreground hover:bg-muted rounded-full focus:outline-none focus:ring-2 focus:ring-primary transition-colors"
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between">
            ...
            <div className="ml-2 flex flex-col items-end space-y-1">
              <span className="text-xs text-muted-foreground/70 whitespace-nowrap">{timeAgo()}</span>
              {!notification.read && (
          ...
          <div className="mt-2 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              {notification.actionLabel && deepLinkUrl && (
                <Link
                  to={deepLinkUrl}
                  className="inline-flex items-center px-2.5 py-1 border border-border rounded-full text-xs font-medium text-primary hover:bg-primary/10"
                >

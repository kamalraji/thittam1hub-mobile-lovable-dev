        ...
        {quickNavItems.map((item) => {
          ...
          return (
            <button
              ...
              className="flex flex-col items-center justify-center gap-2 p-5 rounded-2xl bg-card border border-border hover:bg-muted/50 transition-colors shadow-sm"
            >
          ...
          {events && events.length > 0 ? (
            events.map((event) => (
              <button
                ...
                className="w-full flex items-center gap-3 p-3 bg-card border border-border rounded-xl hover:bg-muted/50 transition-colors"
              >
